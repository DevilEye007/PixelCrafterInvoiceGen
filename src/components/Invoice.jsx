...
const Invoice = ({ invoiceData }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto border p-6 bg-white text-gray-900 font-sans print:bg-white print:text-black print:border-none">
      {/* Header */}
      <div className="bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] text-white p-6 rounded-t-md print:bg-gray-800 print:text-white">
        <div className="flex justify-between items-center">
          ...
          <div className="text-right">
            ...
            <p className="mt-2"><span className='font-bold'>Invoice #:</span> {invoiceNumber}</p>
      ...
      {/* Terms */}
      <div className="mt-4 text-xs text-gray-600 print:text-gray-800">
      ...
      {/* Signature */}
      <div className="mt-8 flex justify-between items-center print:mt-6">
        <button
          onClick={handlePrint}
